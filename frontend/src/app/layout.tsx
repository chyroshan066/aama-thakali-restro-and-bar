...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Nepali BBQ at Aama Thakali. Savor traditional grilled meats, momos, and Himalayan flavors in a warm, welcoming atmosphere. Fresh ingredients, bold spices, and time-honored recipes.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "The Aama Thakali Restaurant & Bar Preview",
      }
    ],
  },
  category: "restaurant",
