...
const alertStyles = {
    success: {
        container: "bg-[var(--emerald-sage)]/10 border-l-4 border-[var(--emerald-sage)]",
        icon: "text-[var(--emerald-sage)]",
        title: "text-[var(--emerald-sage)]",
        message: "text-white/90",
        closeButton: "text-[var(--emerald-sage)] hover:text-white hover:bg-[var(--emerald-sage)]/20",
        name: "checkmark-circle-outline",
    },
    error: {
        container: "bg-[var(--deep-charcoal-2)] border-l-4 border-[var(--warm-stone)]",
        icon: "text-[var(--warm-stone)]",
        title: "text-white",
        message: "text-[var(--warm-stone)]",
        closeButton: "text-[var(--warm-stone)] hover:text-white hover:bg-[var(--deep-charcoal-1)]",
        name: "bug-outline",
    },
} as const;
